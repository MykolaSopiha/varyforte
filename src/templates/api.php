...
try{
	...
	$lead = $api_connector->create(array(
		'name'			=> $_POST['name'],
		'phone'			=> $_POST['phone'],
		'offer_id'		=> '1527',                                                          		// Тут має бути offer_id товара, його можна знайти в ПК
		'stream_id'		=> '18916',                                                    				// Тут, за потребою, ти можеш вказати стрім
...
{
    public $config = array(
        'api_key' => 'dd059623ec28d3a90a296d336c2ee336',                                     		// Тут має бути api_key користувача
        'user_id' =>  '5313',                                                              			// Тут має бути user_id користувача
